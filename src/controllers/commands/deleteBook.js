...
const { deleteBookWithQuantityQuery } = require("../../service/queries/deleteBookWithQuantityQuery");
  ...
  try {
    ...
    collector.on("collect", async (response) => {
      ...
      if (
        ...
        await deleteBookWithQuantityQuery(message, connection, book, parsedQuantity);
      }
