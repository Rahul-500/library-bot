...
exports.GET_AVAILABLE_BEFORE_CHECKOUT_MESSAGE = 'Please use `/available-books` command to get the list of available books before using `/checkout`.'
...
exports.GET_AVAILABLE_BEFORE_RETURN_MESSAGE = "Please use `/my-books` command to get the list of checked out books before using `/return`."
...
exports.QUANTITY_NOT_IN_LIMIT_MESSAGE = 'Invalid quantity. Please provide a quantity within the specified limit. Please try again by entering `/delete-book` command';
...
exports.INVALID_DELETE_DETAILS_MESSAGE = "Please try again by entering `/delete-book` command as the provided data is in incorrect format."
exports.UNEXPECTED_ADD_ERROR_MESSAGE = 'An unexpected error occurred while processing the command. Please try again by entering `/add-book` command.'
exports.UNEXPECTED_DELETE_ERROR_MESSAGE = 'An unexpected error occurred while processing the command. Please try again by entering `/delete-book` command.'
...
exports.UPDATE_BOOK_ID_PROMPT_MESSAGE = "Please enter the ID of the book you want to update (type `exit` to cancel)";
exports.EXIT_REMOVE_MESSAGE = "Exiting the book update process";
exports.INVALID_BOOK_ID_MESSAGE = "Invalid book ID. Please enter a valid book ID";
exports.BOOK_ID_VALID_MESSAGE = "Book ID is valid. You can now enter the details for the update";
exports.UPDATE_BOOK_PROMPT_MESSAGE = "Enter the book details in the following format: Title; Author; Published Year; Quantity Available. Leave it blank for no updates or type `exit` to cancel.";
exports.INVALID_UPDATE_DETAILS_MESSAGE = "Invalid book details. Please make sure to enter valid information.";
